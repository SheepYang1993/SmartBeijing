...
public class CustomViewAbove extends ViewGroup {
	...
	public interface OnPageChangeListener {
		...
		/**
		 * This method will be invoked when a newscenter page becomes selected. Animation is not
		 * necessarily complete.
		 *
		 * @param position Position index of the newscenter selected page.
		 */
	 ...
	 *
	 * @param item Item index to select
	 * @param smoothScroll True to smoothly scroll to the newscenter item, false to transition immediately
	 */
	...
	private void onSecondaryPointerUp(MotionEvent ev) {
		...
		if (pointerId == mActivePointerId) {
			// This was our active pointer going up. Choose a newscenter
