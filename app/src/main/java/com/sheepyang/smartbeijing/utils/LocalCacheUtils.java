...
public class LocalCacheUtils {
	...
	private static final String LOCAL_CACHE_PATH = Environment
			.getExternalStorageDirectory().getAbsolutePath() + "/sheepyang_cache";
	...
	public void setLocalCache(String url, Bitmap bitmap) {
		...
		try {
			...
			bitmap.compress(CompressFormat.JPEG, 100, new FileOutputStream(cacheFile));// 参1:图片格式;参2:压缩比例0-100; 参3:输出流
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
